...
string AndroidPlatformHelpers::getDataResource (const string &filename) {
...
string AndroidPlatformHelpers::getImageResource (const string &filename) {
...
string AndroidPlatformHelpers::getRingResource (const string &filename) {
...
string AndroidPlatformHelpers::getSoundResource (const string &filename) {
