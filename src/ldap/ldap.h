...
public:
	...
	// Create a Ldap instance from configuration at section name. Return nullptr if this is not an ldap configuration (section name different from "ldap_n" or "ldap")
