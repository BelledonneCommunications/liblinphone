...
void serializeResource(::std::ostream &os,
...
void serializeResource(::xercesc::XMLFormatTarget &ft,
                       const ::LinphonePrivate::Xsd::Rlmi::Resource &x,
                       const ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap &m =
                           ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap(),
                       const ::std::string &e = "UTF-8",
...
void serializeInstance(::std::ostream &os,
...
void serializeInstance(::xercesc::XMLFormatTarget &ft,
                       const ::LinphonePrivate::Xsd::Rlmi::Instance &x,
                       const ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap &m =
                           ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap(),
                       const ::std::string &e = "UTF-8",
...
void serializeName(::std::ostream &os,
...
void serializeName(::xercesc::XMLFormatTarget &ft,
                   const ::LinphonePrivate::Xsd::Rlmi::Name &x,
                   const ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap &m =
                       ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap(),
                   const ::std::string &e = "UTF-8",
