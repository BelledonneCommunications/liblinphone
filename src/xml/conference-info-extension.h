...
#ifndef XML_CONFERENCE_INFO_EXTENSION_H
#define XML_CONFERENCE_INFO_EXTENSION_H
...
namespace LinphonePrivate
{
  namespace Xsd
  {
    namespace ConferenceInfoExtension
    {
      class ConferenceTypeExtension: public ::LinphonePrivate::Xsd::XmlSchema::Type
      {
        public:
        // ephemeral
        //
        typedef ::LinphonePrivate::Xsd::ConferenceInfoExtension::EphemeralType EphemeralType;
        ...
        // Constructors.
        //
        ConferenceTypeExtension (const EphemeralType&);

        ConferenceTypeExtension (::std::unique_ptr< EphemeralType >);
        ...
        virtual ConferenceTypeExtension*
        ...
        ::xsd::cxx::tree::one< EphemeralType > ephemeral_;
      ...
      class EphemeralType: public ::LinphonePrivate::Xsd::XmlSchema::Type
      {
        ...
        // Constructors.
        //
        EphemeralType (const LifetimeType&);
...
namespace LinphonePrivate
{
  namespace Xsd
  {
    ...
    {
      ::std::ostream&
      operator<< (::std::ostream&, const ConferenceTypeExtension&);
...
namespace LinphonePrivate
{
  namespace Xsd
  {
    namespace ConferenceInfoExtension
    {
      ...
      parseConference_info_extension (const ::std::string& uri,
                                      ::LinphonePrivate::Xsd::XmlSchema::Flags f = 0,
      ...
      ::std::unique_ptr< ::LinphonePrivate::Xsd::ConferenceInfoExtension::ConferenceTypeExtension >
      parseConference_info_extension (::xercesc::InputSource& is,
                                      ::LinphonePrivate::Xsd::XmlSchema::Flags f = 0,
                                      const ::LinphonePrivate::Xsd::XmlSchema::Properties& p = ::LinphonePrivate::Xsd::XmlSchema::Properties ());
      ...
      ::std::unique_ptr< ::LinphonePrivate::Xsd::ConferenceInfoExtension::ConferenceTypeExtension >
      parseConference_info_extension (const ::xercesc::DOMDocument& d,
                                      ::LinphonePrivate::Xsd::XmlSchema::Flags f = 0,
                                      const ::LinphonePrivate::Xsd::XmlSchema::Properties& p = ::LinphonePrivate::Xsd::XmlSchema::Properties ());
...
namespace LinphonePrivate
{
  namespace Xsd
  {
    namespace ConferenceInfoExtension
    {
      ...
      void
      serializeConferenceInfoExtension (::std::ostream& os,
                                        const ::LinphonePrivate::Xsd::ConferenceInfoExtension::ConferenceTypeExtension& x, 
      ...
      void
      serializeConferenceInfoExtension (::xercesc::XMLFormatTarget& ft,
                                        const ::LinphonePrivate::Xsd::ConferenceInfoExtension::ConferenceTypeExtension& x, 
                                        const ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap& m = ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap (),
                                        const ::std::string& e = "UTF-8",
                                        ::LinphonePrivate::Xsd::XmlSchema::Flags f = 0);
      ...
      serializeConferenceInfoExtension (const ::LinphonePrivate::Xsd::ConferenceInfoExtension::ConferenceTypeExtension& x, 
                                        const ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap& m = ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap (),
                                        ::LinphonePrivate::Xsd::XmlSchema::Flags f = 0);

      void
      operator<< (::xercesc::DOMElement&, const ConferenceTypeExtension&);
...
#endif // XML_CONFERENCE_INFO_EXTENSION_H
