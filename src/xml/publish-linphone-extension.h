  ...
  namespace Xsd
  {
    namespace PublishLinphoneExtension
    {
      class CryptoType: public ::LinphonePrivate::Xsd::XmlSchema::Type
      {
        ...
        void
        setCiphers (::std::unique_ptr< CiphersType > p);
      ...
      class CiphersType: public ::LinphonePrivate::Xsd::XmlSchema::Type
      {
        ...
        const EncryptedektSequence&
        getEncryptedekt () const;

        EncryptedektSequence&
        getEncryptedekt ();
...
namespace LinphonePrivate
{
  namespace Xsd
  {
    ...
    {
      ::std::ostream&
      operator<< (::std::ostream&, const CryptoType&);

      ::std::ostream&
      operator<< (::std::ostream&, const CiphersType&);

      ::std::ostream&
      operator<< (::std::ostream&, const EncryptedektType&);
    }
  }
}
...
namespace LinphonePrivate
{
  namespace Xsd
  {
    namespace PublishLinphoneExtension
    {
      ...
      void
      serializeCrypto (::std::ostream& os,
      ...
      void
      serializeCrypto (::xercesc::XMLFormatTarget& ft,
                       const ::LinphonePrivate::Xsd::PublishLinphoneExtension::CryptoType& x, 
                       const ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap& m = ::LinphonePrivate::Xsd::XmlSchema::NamespaceInfomap (),
                       const ::std::string& e = "UTF-8",
                       ::LinphonePrivate::Xsd::XmlSchema::Flags f = 0);
      ...
      void
      operator<< (::xercesc::DOMElement&, const CiphersType&);

      void
      operator<< (::xercesc::DOMElement&, const EncryptedektType&);
    }
  }
}
