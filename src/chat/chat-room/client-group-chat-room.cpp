...
// Will be called when sending a message into a chat room previously terminated by remote end
...
// Will be called when remote end of conference exhumes a chat room it previously terminated
