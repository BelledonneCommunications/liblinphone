...
bool CallPrivate::microphoneMuted () const {
	return static_pointer_cast<MediaSession>(getActiveSession())->getPrivate()->microphoneMuted();
}

void CallPrivate::muteMicrophone (bool muted) {
	static_pointer_cast<MediaSession>(getActiveSession())->getPrivate()->muteMicrophone(muted);
}
