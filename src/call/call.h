...
public:
	...
	void setInputAudioDevice(std::shared_ptr<AudioDevice> audioDevice);
	void setOutputAudioDevice(std::shared_ptr<AudioDevice> audioDevice);
	void setAudioDevice(std::shared_ptr<AudioDevice> audioDevice);
