...
LinphoneDigestAuthenticationPolicy * linphone_digest_authentication_policy_new_from_config(LinphoneConfig *config){
	...
	linphone_digest_authentication_policy_set_allow_md5(policy, linphone_config_get_bool(config, digest_authentication_policy_key, "allow_md5", TRUE));
	linphone_digest_authentication_policy_set_allow_no_qop(policy, linphone_config_get_bool(config, digest_authentication_policy_key, "allow_no_qop", TRUE));
	return policy;
}
