...
LinphoneStatus linphone_account_params_set_server_addr(LinphoneAccountParams *params, const char *server_address) {
	return AccountParams::toCpp(params)->setServerAddr(server_address);
}
...
void linphone_account_params_set_use_international_prefix_for_calls(LinphoneAccountParams* params, bool_t enable) {
	AccountParams::toCpp(params)->setUseInternationalPrefixForCalls(enable);
}
...
const char* linphone_account_params_get_server_addr(const LinphoneAccountParams *params) {
	return L_STRING_TO_C(AccountParams::toCpp(params)->getServerAddr());
}
...
bool_t linphone_account_params_get_use_international_prefix_for_calls(const LinphoneAccountParams *params) {
	return AccountParams::toCpp(params)->getUseInternationalPrefixForCalls();
}
