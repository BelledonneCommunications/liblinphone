...
const LinphoneAddress *linphone_conference_info_get_organizer(LinphoneConferenceInfo *conference_info) {
...
const bctbx_list_t *linphone_conference_info_get_participants(LinphoneConferenceInfo *conference_info) {
...
const LinphoneAddress *linphone_conference_info_get_uri(LinphoneConferenceInfo *conference_info) {
...
time_t linphone_conference_info_get_date_time(LinphoneConferenceInfo *conference_info) {
...
int linphone_conference_info_get_duration(LinphoneConferenceInfo *conference_info) {
...
const char *linphone_conference_info_get_subject(LinphoneConferenceInfo *conference_info) {
...
const char *linphone_conference_info_get_description(LinphoneConferenceInfo *conference_info) {
...
char *linphone_conference_info_get_icalendar_string(LinphoneConferenceInfo *conference_info) {
