...
private:
	...
	#ifdef DEBUG
		static LINPHONE_PUBLIC void setName (belle_sip_object_t *cObject, const BaseObject *cppObject);
		static LINPHONE_PUBLIC void setName (belle_sip_object_t *cObject, const ClonableObject *cppObject);
	#endif
