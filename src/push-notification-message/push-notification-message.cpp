...
PushNotificationMessage::PushNotificationMessage(bool isUsingUserDefaults, const std::string &callId, bool isText, const std::string &textContent, const std::string &subject, const std::string &fromAddr, const std::string &localAddr, const std::string &peerAddr) {
    PushNotificationMessage::init(isUsingUserDefaults, callId, isText, textContent, subject, fromAddr, localAddr, peerAddr);
}

void PushNotificationMessage::init(bool isUsingUserDefaults, const std::string &callId, bool isText, const std::string &textContent, const std::string &subject, const std::string &fromAddr, const std::string &localAddr, const std::string &peerAddr) {
