...
protected:
	...
	RtpProfile * makeProfile(const std::shared_ptr<SalMediaDescription> & md, const SalStreamDescription & desc, int *usedPt);
...
private:
	...
	bool mStopStream = false;	// Set to true if the stream need to stop on render().
