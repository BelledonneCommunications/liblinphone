...
lInfo() << __func__ << " DEBUG DEBUG DTLS result stream " << stream.hasDtls() << " remote " <<  params.getRemoteStreamDescription().hasDtls() << " finger print " << params.getRemoteStreamDescription().getChosenConfiguration().dtls_fingerprint;
...
lError() << __func__ << " DEBUG DEBUG stream type " << sal_stream_type_to_string(getType());
	...
	if (resultStreamDesc.getChosenConfiguration().dtls_role == SalDtlsRoleInvalid){
		...
		/* Give the peer certificate fingerprint to dtls context */
lInfo() << __func__ << " DEBUG DEBUG DTLS result stream " << resultStreamDesc.hasDtls() << " remote " <<  params.getRemoteStreamDescription().hasDtls() << " finger print " << params.getRemoteStreamDescription().getChosenConfiguration().dtls_fingerprint;
