...
public:
	...
	*/
	virtual void onParticipantDeviceAlerting (const std::shared_ptr<ConferenceParticipantDeviceEvent> &event, const std::shared_ptr<ParticipantDevice> &device) override;
