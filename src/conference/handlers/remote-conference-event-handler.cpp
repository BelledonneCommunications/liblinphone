...
void RemoteConferenceEventHandler::onAccountRegistrationStateChanged (BCTBX_UNUSED(std::shared_ptr<Account> account), LinphoneRegistrationState state, BCTBX_UNUSED(const std::string &message)) {
