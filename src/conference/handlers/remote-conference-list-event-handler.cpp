...
void RemoteConferenceListEventHandler::notifyReceived (const Content *notifyContent) {
	...
	if ((notifyContent->getContentType() == ContentType::ConferenceInfo) || (notifyContent->getContentType() == ContentType::ConferenceInfoExtension)) {
	...
	for (const auto &content : contents) {
		...
		else if ((contentType == ContentType::ConferenceInfo) || (contentType == ContentType::ConferenceInfoExtension))
