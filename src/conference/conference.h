...
public:
	...
	void notifyParticipantDeviceJoinedConference (const std::shared_ptr<ParticipantDevice> & device) const;
	void notifyParticipantDeviceLeftConference (const std::shared_ptr<ParticipantDevice> & device) const;
