...
/*
 * This interface allow an application to manage a multimedia conference. Implementation folows 2 mains rfc4579 ( SIP Call Control - Conferencing for User Agents) and rfc4575 ( A Session Initiation Protocol (SIP) Event Package for Conference State). It can be  either a Focus user agent (I.E local conference) or belong to a remote focus user agent (I.E remote conference). <br>
*
*	<br>
...
public:
	...
	*/
	...
	/*
	 * Change the admin status of a participant of this conference (If not focus,  This operation is only available if the local participant  #getMe() is admin). All particpants are notified of subject change.
	...
	*/
	 ...
	 */
	virtual bool addParticipant (Call *call) = 0;
	...
	*/
	...
	/*
	 * Add local particpant to this conference, this fonction is only available for local focus. Behavior is the same as
	 */
	...
	*<b>Local focus case: </b><br>
	*Local particpant is not mandatory. From value taken during conference managements is focus address.
	<b>Remote focus case: </b><br>
	*Local particpant is the Participant of this conference used as From when operations are performed like subject change or participant management. local particpant is not included in the of particpant returned by function. Local particpant is mandatory to create a remote conference conference.
	...
	*/
	 ...
	 *<b>Local focus case: </b><br>
	 * Remainning particpant are notified. Conference state does not change.
	 *<b>Remote focus case: </b><br>
	 ...
	 * @return True if everything is OK, False otherwise
	 */
	bool update(const ConferenceParamsInterface &newParameters);
