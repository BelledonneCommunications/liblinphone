...
shared_ptr<AbstractChatRoom> MainDb::mergeChatRooms(const shared_ptr<AbstractChatRoom> chatRoom1,
	...
	const auto &chatRoom1Backend = chatRoom1->getCurrentParams()->getChatRoomBackend();
	auto chatRoom1IsFlexisipChat = (chatRoom1Backend == ChatRoomParams::Backend::FlexisipChat);
	...
	const auto &chatRoom2Backend = chatRoom2->getCurrentParams()->getChatRoomBackend();
	auto chatRoom2IsFlexisipChat = (chatRoom2Backend == ChatRoomParams::Backend::FlexisipChat);
