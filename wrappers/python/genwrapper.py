...
if __name__ == '__main__':
    ...
    parser.forceFunctionRename = {
        'linphone_factory_create_core_3': 'linphone_factory_create_core', 
        'linphone_factory_create_core_with_config_3': 'linphone_factory_create_core_with_config'
    }
    parser.functionBl = \
    ...
    wrapper = LinphoneDoc(parser)
    render(renderer, wrapper, args.outputdir + '/linphone_doc.py')
