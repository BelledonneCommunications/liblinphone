 ...
 * @param vCard #LinphoneVcard object
 ...
 * @param vCard the #LinphoneVcard
 * @param sip_address the SIP address to add
 */
 ...
 * @param vCard the #LinphoneVcard
 * @param sip_address the SIP address to remove
 */
 ...
 * @param vCard the #LinphoneVcard
 * @param sip_address the new SIP address
 */
