 ...
 * @param[in] player #LinphonePlayer object.
 * @param[in] user_data The user pointer to associate with the player. @maybenil
**/
 ...
 * @param[in] cbs #LinphonePlayerCbs object.
 * @param[in] user_data The user pointer to associate with the #LinphonePlayerCbs object. @maybenil
 */
