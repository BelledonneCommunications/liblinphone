 ...
 * @ingroup media_parameters
 */
LINPHONE_PUBLIC void linphone_core_set_supported_media_encryptions(LinphoneCore *lc, const bctbx_list_t * enc_list);

/**
 * Get list of supported media descriptions.
 * @param core #LinphoneCore object. @notnil
 * @return list of supported media encryptions as strings. They can be converted to #LinphoneMediaEncryption by calling linphone_media_encryption_from_string. \bctbx_list{char *} @notnil
 * @ingroup media_parameters
 */
