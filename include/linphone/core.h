 ...
 * @param core A #LinphoneCore object @notnil
 * @param mode the chosen mode as a string
 */
LINPHONE_PUBLIC void linphone_core_set_media_resource_mode (LinphoneCore *core, const char *mode);

/**
 * This function returns the media resource mode for this core
 * @param core A #LinphoneCore object @notnil
 * @return The media resource mode as a string
 */
LINPHONE_PUBLIC const char *linphone_core_get_media_resource_mode (const LinphoneCore *core);
