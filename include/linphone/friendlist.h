 ...
 * @param friend_list #LinphoneFriendList object.
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param display_name The new display name of the friend list.
**/
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param rls_uri The RLS URI to associate with the friend list.
**/
 ...
 * Set the RLS (Resource List Server) URI associated with the friend list to subscribe to these friends presence.
 * @param friend_list #LinphoneFriendList object.
 * @param rls_addr The RLS URI to associate with the friend list.
**/
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param linphone_friend #LinphoneFriend object to add to the friend list.
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param linphone_friend #LinphoneFriend object to remove from the friend list.
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param address #LinphoneAddress object of the friend we want to search for.
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param phone_number a string of the phone number for which we want to find a friend.
 * @return A #LinphoneFriend if found, NULL otherwise. @maybenil
 * @maybenil
**/
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param address #LinphoneAddress object of the friends we want to search for.
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param ref_key The ref key string of the friend we want to search for.
 * @return A #LinphoneFriend if found, NULL otherwise. @maybenil
**/
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param presence #LinphonePresenceModel object.
**/
 ...
 * @param friend_list #LinphoneFriendList object.
 * @param a boolean telling if the subscription of the friend list is bodyless or not.
**/
 ...
 * @param friend_list #LinphoneFriendList object
 * @param cbs The current #LinphoneFriendListCbs object to be added to the LinphoneFriendList.
**/
 ...
 * @param friend_list #LinphoneFriendList object
 * @param cbs The current #LinphoneFriendListCbs object to be remove from the LinphoneFriendList.
**/
 ...
 * @param cbs #LinphoneFriendListCbs object.
 ...
 * @param list the #LinphoneFriendList object
 * @param vcard_file the path to a file that contains the vCard(s) to parse
 ...
 * @param list the #LinphoneFriendList object
 * @param vcard_buffer the buffer that contains the vCard(s) to parse
 * @return the amount of linphone friends created
 */
 ...
 * @param list the #LinphoneFriendList object
 * @param vcard_file the path to a file that will contain the vCards
 */
