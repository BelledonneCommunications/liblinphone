 ...
 * @deprecated 10/07/2020 Use linphone_conference_remove_participant_with_participant() instead.
 */
 ...
 * @return 0 if succeeded, -1 if failed
 */
LINPHONE_PUBLIC LinphoneStatus linphone_conference_remove_participant_with_participant(LinphoneConference *obj, LinphoneParticipant *participant);
