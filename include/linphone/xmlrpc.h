 ...
 **/
LINPHONE_PUBLIC LinphoneXmlRpcRequest *linphone_xml_rpc_request_new(LinphoneXmlRpcArgType return_type,
                                                                    const char *method);
 ...
 **/
LINPHONE_PUBLIC void linphone_xml_rpc_request_add_callbacks(LinphoneXmlRpcRequest *request,
 ...
 **/
LINPHONE_PUBLIC void linphone_xml_rpc_request_remove_callbacks(LinphoneXmlRpcRequest *request,
                                                               LinphoneXmlRpcRequestCbs *cbs);
 ...
 **/
LINPHONE_PUBLIC LinphoneXmlRpcRequestCbs *
linphone_xml_rpc_request_get_current_callbacks(const LinphoneXmlRpcRequest *request);
...
/**
 * Get the response to an XML-RPC request sent with linphone_xml_rpc_session_send_request() and returning an integer
 *response.
 * @param request #LinphoneXmlRpcRequest object. @notnil
...
/**
 * Get the response to an XML-RPC request sent with linphone_xml_rpc_session_send_request() and returning a string
 *response.
 * @param request LinphoneXmlRpcRequest object. @notnil
...
/**
 * Get the response to an XML-RPC request sent with linphone_xml_rpc_session_send_request() and returning a struct
 *response.
 * @param request LinphoneXmlRpcRequest object. @notnil
 ...
 * @param session #LinphoneXmlRpcSession object. @notnil
 * @warning This will not stop pending xml-rpc requests. Use linphone_xml_rpc_session_release() instead if this is
 *intended.
 **/
 ...
 **/
LINPHONE_PUBLIC void linphone_xml_rpc_session_send_request(LinphoneXmlRpcSession *session,
 ...
 **/
LINPHONE_PUBLIC LinphoneXmlRpcRequestCbsResponseCb
linphone_xml_rpc_request_cbs_get_response(const LinphoneXmlRpcRequestCbs *cbs);
 ...
 **/
LINPHONE_PUBLIC void linphone_xml_rpc_request_cbs_set_response(LinphoneXmlRpcRequestCbs *cbs,
 ...
 */
LINPHONE_PUBLIC LinphoneXmlRpcRequest *linphone_xml_rpc_session_create_request(LinphoneXmlRpcSession *session,
 ...
 * @donotwrap
 **/
LINPHONE_PUBLIC LINPHONE_DEPRECATED LinphoneXmlRpcRequestCbs *
linphone_xml_rpc_request_get_callbacks(const LinphoneXmlRpcRequest *request);
