 ...
 * @param return_type The expected XML-RPC response type.
 * @param method The XML-RPC method to call.
 ...
 * @param request #LinphoneXmlRpcRequest object
 * @param cbs The #LinphoneXmlRpcRequestCbs object to add to the LinphoneXmlRpcRequest.
**/
 ...
 * @param request #LinphoneXmlRpcRequest object
 * @param cbs The #LinphoneXmlRpcRequestCbs object to remove from the LinphoneXmlRpcRequest.
**/
 ...
 * @param core The #LinphoneCore object used to send the XML-RPC requests.
 * @param url The URL of the XML-RPC server to send the XML-RPC requests to.
 ...
 * @param session #LinphoneXmlRpcSession object.
 ...
 * @param session #LinphoneXmlRpcSession object.
 * @param request The #LinphoneXmlRpcRequest to be sent.
**/
 ...
 * @param cbs #LinphoneXmlRpcRequestCbs object.
 ...
 * @param session the #LinphoneXmlRpcSession
