 ...
 * @param[in] call_log #LinphoneCallLog object
 ...
 * @param[in] call_log #LinphoneCallLog object
 * @return The origin #LinphoneAddress (ie from) of the call.
**/
 ...
 * @return The local #LinphoneAddress of the call
 */
 ...
 * @param[in] call_log #LinphoneCallLog object
 * @return The remote #LinphoneAddress of the call.
**/
 ...
 * @param[in] call_log #LinphoneCallLog object
 * @return The destination #LinphoneAddress (ie to) of the call.
**/
 ...
 *
 * @param[in] call_log #LinphoneCallLog object
 * @param[in] refkey The reference key string to associate to the call log. @maybenil
**/
 ...
 * @param[in] call_log #LinphoneCallLog object
 * @param[in] user_data The user data to associate with the call log. @maybenil
**/
