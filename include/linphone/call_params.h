 ...
 * @param[in] call_params The #LinphoneCallParams to add a custom SIP header to.
 ...
 * @param[in] call_params The #LinphoneCallParams object to copy.
 ...
 * @param[in] call_params #LinphoneCallParams object
 ...
 * @param[in] call_params The #LinphoneCallParams to get the custom SIP header from.
 ...
 * @deprecated 22/11/2017 Use #linphone_call_params_get_received_video_definition() instead. Deprecated since 2017-03-28.
 * @donotwrap
 */
 ...
 * @param[in] call_params #LinphoneCalParams object
 * @return The sent video size or MS_VIDEO_SIZE_UNKNOWN if not available.
 * @deprecated 22/11/2017 Use #linphone_call_params_get_sent_video_definition() instead. Deprecated since 2017-03-28.
 * @donotwrap
 */
 ...
 * @param[in] call_params #LinphoneCallParams object
 * @param[in] bandwidth The audio bandwidth limit to set in kbit/s.
**/
 ...
 * @param[in] call_params #LinphoneCallParams object
 * @param[in] encryption The #LinphoneMediaEncryption to use for the call.
**/
 ...
 * @param[in] call_params #LinphoneCallParams object
 * @param[in] privacy The #LinphonePrivacyMask to used for the call.
**/
 ...
 * @param[in] call_params #LinphoneCallParams object
 * @param[in] direction The audio stream #LinphoneMediaDirection associated with this call params.
**/
 ...
 * @param[in] call_params #LinphoneCallParams object
 * @param[in] direction The video stream #LinphoneMediaDirection associated with this call params.
**/
 ...
 * @param[in] call_params #LinphoneCallParams object
 * @param[in] user_data The user data to associate with the call params. @maybenil
**/
