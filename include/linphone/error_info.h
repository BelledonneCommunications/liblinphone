 ...
 */
LINPHONE_PUBLIC void linphone_error_info_set(LinphoneErrorInfo *error_info,
                                             const char *protocol,
 ...
 */
LINPHONE_PUBLIC void linphone_error_info_set_sub_error_info(LinphoneErrorInfo *error_info,
