 ...
 * @deprecated 17/0/2020 Use #LinphoneChatMessageCbsFileTransferSend2Cb instead.
 */
 ...
 */
typedef void (*LinphoneChatMessageCbsFileTransferSend2Cb)(LinphoneChatMessage *message, LinphoneContent* content, size_t offset, size_t size, LinphoneBuffer *buffer);
