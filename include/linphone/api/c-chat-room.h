...
// Note that these methods must be updated if either the value of conference state or chat room state change. The compiler will throw an error if not doing it.
