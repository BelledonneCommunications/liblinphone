 ...
 **/
LINPHONE_PUBLIC bctbx_list_t *linphone_magic_search_get_contacts (
...
LINPHONE_PUBLIC void linphone_magic_search_get_contacts_async (
	LinphoneMagicSearch *magic_search,
	const char *filter,
	const char *domain,
	int sourceFlags);
 ...
 * - "yourdomain" for searching in contact from "yourdomain" domain
 * @return sorted list of \bctbx_list{LinphoneSearchResult} @tobefreed @notnil
 ** @deprecated 22/04/2022 Use linphone_magic_search_get_contacts() instead.
 **/
 ...
 ** "*" for searching in contact with sip SipUri
 ** "yourdomain" for searching in contact from "yourdomain" domain
 ** @deprecated 22/04/2022 Use linphone_magic_search_get_contacts_async() instead.
 **/
//typedef void (MagicSearchCb)(const void *, void *);
