...
#ifndef L_C_FRIEND_LIST_H_
#define L_C_FRIEND_LIST_H_
 ...
 **/
LINPHONE_PUBLIC void linphone_friend_list_set_rls_address(LinphoneFriendList *friend_list,
                                                          const LinphoneAddress *rls_addr);

/**
 * Add a friend to a friend list. If or when a remote CardDAV server will be attached to the list, the friend will be
 *sent to the server.
 * @param friend_list #LinphoneFriendList object. @notnil
 ...
 **/
LINPHONE_PUBLIC LinphoneFriendListStatus linphone_friend_list_add_friend(LinphoneFriendList *friend_list,
 ...
 * @return #LinphoneFriendListOK if successfully added, #LinphoneFriendListInvalidFriend if the friend is not valid.
 **/
LINPHONE_PUBLIC LinphoneFriendListStatus linphone_friend_list_add_local_friend(LinphoneFriendList *friend_list,
                                                                               LinphoneFriend *linphone_friend);
 ...
 * @return #LinphoneFriendListOK if removed successfully, #LinphoneFriendListNonExistentFriend if the friend is not in
 *the list.
 **/
 ...
 **/
LINPHONE_PUBLIC LinphoneFriend *linphone_friend_list_find_friend_by_address(const LinphoneFriendList *friend_list,
 ...
 * @return A #LinphoneFriend if found, NULL otherwise. @maybenil
 **/
LINPHONE_PUBLIC LinphoneFriend *linphone_friend_list_find_friend_by_phone_number(const LinphoneFriendList *friend_list,
 ...
 **/
LINPHONE_PUBLIC bctbx_list_t *linphone_friend_list_find_friends_by_address(const LinphoneFriendList *friend_list,
                                                                           const LinphoneAddress *address);
 ...
 * @return A #LinphoneFriend if found, NULL otherwise. @maybenil
 **/
LINPHONE_PUBLIC LinphoneFriend *linphone_friend_list_find_friend_by_uri(const LinphoneFriendList *friend_list,
                                                                        const char *uri);
 ...
 * @return A list of #LinphoneFriend if found, NULL otherwise. \bctbx_list{LinphoneFriend} @maybenil
 **/
LINPHONE_PUBLIC bctbx_list_t *linphone_friend_list_find_friends_by_uri(const LinphoneFriendList *friend_list,
                                                                       const char *uri);
 ...
 * @return A #LinphoneFriend if found, NULL otherwise. @maybenil
 **/
LINPHONE_PUBLIC LinphoneFriend *linphone_friend_list_find_friend_by_ref_key(const LinphoneFriendList *friend_list,
                                                                            const char *ref_key);

/**
 * Update presence subscriptions for the entire list. Calling this function is necessary when list subscriptions are
 *enabled, ie when a RLS presence server is used.
...
/**
 * Notify our presence to all the friends in the friend list that have subscribed to our presence directly (not using a
 *RLS).
 * @param friend_list #LinphoneFriendList object. @notnil
 * @param presence #LinphonePresenceModel object. @notnil
 **/
LINPHONE_PUBLIC void linphone_friend_list_notify_presence(LinphoneFriendList *friend_list,
 ...
 **/
LINPHONE_PUBLIC LinphoneFriendListCbs *
linphone_friend_list_get_current_callbacks(const LinphoneFriendList *friend_list);
 ...
 **/
LINPHONE_PUBLIC LinphoneFriendListCbsContactCreatedCb
linphone_friend_list_cbs_get_contact_created(const LinphoneFriendListCbs *cbs);
 ...
 **/
LINPHONE_PUBLIC void linphone_friend_list_cbs_set_contact_created(LinphoneFriendListCbs *cbs,
 ...
 **/
LINPHONE_PUBLIC LinphoneFriendListCbsContactDeletedCb
linphone_friend_list_cbs_get_contact_deleted(const LinphoneFriendListCbs *cbs);
 ...
 **/
LINPHONE_PUBLIC void linphone_friend_list_cbs_set_contact_deleted(LinphoneFriendListCbs *cbs,
 ...
 **/
LINPHONE_PUBLIC LinphoneFriendListCbsContactUpdatedCb
linphone_friend_list_cbs_get_contact_updated(const LinphoneFriendListCbs *cbs);
 ...
 **/
LINPHONE_PUBLIC void linphone_friend_list_cbs_set_contact_updated(LinphoneFriendListCbs *cbs,
 ...
 **/
LINPHONE_PUBLIC LinphoneFriendListCbsSyncStateChangedCb
 ...
 **/
LINPHONE_PUBLIC void linphone_friend_list_cbs_set_sync_status_changed(LinphoneFriendListCbs *cbs,
 ...
 **/
LINPHONE_PUBLIC LinphoneFriendListCbsPresenceReceivedCb
 ...
 **/
LINPHONE_PUBLIC void linphone_friend_list_cbs_set_presence_received(LinphoneFriendListCbs *cbs,
 ...
 */
LINPHONE_PUBLIC int linphone_friend_list_import_friends_from_vcard4_file(LinphoneFriendList *friend_list,
 ...
 * @return the amount of linphone friends created
 */
LINPHONE_PUBLIC int linphone_friend_list_import_friends_from_vcard4_buffer(LinphoneFriendList *friend_list,
 ...
 */
LINPHONE_PUBLIC void linphone_friend_list_export_friends_as_vcard4_file(LinphoneFriendList *friend_list,
                                                                        const char *vcard_file);
