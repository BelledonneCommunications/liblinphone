 ...
 * @param message #LinphoneChatMessage object. @notnil
 * @return the original message id. @notnil
 */
 ...
 * Returns the ID of the message this is a reply to.
 * @param message #LinphoneChatMessage object. @notnil
 * @return the original message sender #LinphoneAddress. @notnil
 */
 ...
 * Returns the ID of the message this is a reply to.
 * @param message #LinphoneChatMessage object. @notnil
 * @return \bctbx_list{LinphoneContent} the original message contents. @notnil
 */
LINPHONE_PUBLIC bctbx_list_t* linphone_chat_message_get_reply_message_contents(LinphoneChatMessage *message);
