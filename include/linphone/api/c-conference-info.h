 ...
 */
LINPHONE_PUBLIC const LinphoneAddress *linphone_conference_info_get_organizer(LinphoneConferenceInfo *conference_info);
 ...
 */
LINPHONE_PUBLIC const bctbx_list_t *linphone_conference_info_get_participants(LinphoneConferenceInfo *conference_info);
 ...
 */
LINPHONE_PUBLIC const LinphoneAddress *linphone_conference_info_get_uri(LinphoneConferenceInfo *conference_info);
 ...
 */
LINPHONE_PUBLIC time_t linphone_conference_info_get_date_time(LinphoneConferenceInfo *conference_info);
 ...
 */
LINPHONE_PUBLIC int linphone_conference_info_get_duration(LinphoneConferenceInfo *conference_info);
 ...
 */
LINPHONE_PUBLIC const char *linphone_conference_info_get_subject(LinphoneConferenceInfo *conference_info);
 ...
 */
LINPHONE_PUBLIC const char *linphone_conference_info_get_description(LinphoneConferenceInfo *conference_info);
 ...
 * @param conference_info The #LinphoneConferenceInfo object. @notnil
 * @return The conference as an Icalendar string. The returned char* must be freed by the caller. @maybenil
 */
LINPHONE_PUBLIC char *linphone_conference_info_get_icalendar_string(LinphoneConferenceInfo *conference_info);
