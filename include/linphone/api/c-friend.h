...
#ifndef _L_C_FRIEND_H_
#define _L_C_FRIEND_H_
...
/**
 * @addtogroup linphone_friend
 * @{
 */

/**
 * Initialize a LinphoneFriend
 * @param lf LinphoneFriend object
 */
LINPHONE_PUBLIC void linphone_friend_init(LinphoneFriend *lf);
 ...
 * @deprecated Use linphone_core_create_friend_from_vcard() instead.
 */
LINPHONE_PUBLIC LINPHONE_DEPRECATED LinphoneFriend *linphone_friend_new_from_vcard(LinphoneVcard *vcard);
