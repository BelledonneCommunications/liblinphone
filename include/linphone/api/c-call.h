 ...
 **/
LINPHONE_PUBLIC bool_t linphone_call_microphone_muted (const LinphoneCall *call);
 ...
 **/
LINPHONE_PUBLIC void linphone_call_mute_microphone (LinphoneCall *call, bool_t muted);
