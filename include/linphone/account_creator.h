 ...
 * @param creator LinphoneAccountCreator object.
 * @param cfg The LinphoneProxyConfig to associate with the LinphoneAccountCreator.
**/
 ...
 * @param country_code Country code to associate phone number with
 ...
 * @param creator #LinphoneAccountCreator object
 * @param activation_code The activation code to set
 ...
 * @param creator #LinphoneAccountCreator object
 * @param set_as_default The set_as_default to set
 * @return #LinphoneAccountCreatorStatusRequestOk if everything is OK, or a specific error otherwise.
 **/
 ...
 * @param creator #LinphoneAccountCreator object
 * @param cbs The #LinphoneAccountCreatorCbs object to add to the LinphoneAccountCreator.
**/
 ...
 * @param creator #LinphoneAccountCreator object
 * @param cbs The #LinphoneAccountCreatorCbs object to remove from the LinphoneAccountCreator.
**/
 ...
 * @param cbs #LinphoneAccountCreatorCbs object.
