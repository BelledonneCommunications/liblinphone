 ...
 */
LINPHONE_PUBLIC LinphoneConfig *linphone_config_new_with_factory(const char *config_filename,
 ...
 * defined in the factory config file.
 */
LINPHONE_PUBLIC LinphoneConfig *linphone_config_new_for_shared_core(const char *app_group_id,
 ...
 **/
LINPHONE_PUBLIC const char *linphone_config_get_string(const LinphoneConfig *config,
                                                       const char *section,
                                                       const char *key,
 ...
 */
LINPHONE_PUBLIC bctbx_list_t *linphone_config_get_string_list(const LinphoneConfig *config,
                                                              const char *section,
                                                              const char *key,
 ...
 */
LINPHONE_PUBLIC bool_t linphone_config_get_range(const LinphoneConfig *config,
                                                 const char *section,
                                                 const char *key,
                                                 int *min,
                                                 int *max,
 ...
 **/
LINPHONE_PUBLIC int
linphone_config_get_int(const LinphoneConfig *config, const char *section, const char *key, int default_value);
 ...
 * @return the found value or default_value if not found.
 **/
LINPHONE_PUBLIC bool_t linphone_config_get_bool(const LinphoneConfig *config,
                                                const char *section,
                                                const char *key,
 ...
 * @return the found value or default_value if not found.
 **/
LINPHONE_PUBLIC int64_t linphone_config_get_int64(const LinphoneConfig *config,
                                                  const char *section,
                                                  const char *key,
 ...
 * @return the found value or default_value if not found.
 **/
LINPHONE_PUBLIC float
linphone_config_get_float(const LinphoneConfig *config, const char *section, const char *key, float default_value);
...
linphone_config_set_string(LinphoneConfig *config, const char *section, const char *key, const char *value);
 ...
 */
LINPHONE_PUBLIC void linphone_config_set_string_list(LinphoneConfig *config,
                                                     const char *section,
                                                     const char *key,
 ...
 */
LINPHONE_PUBLIC void
linphone_config_set_range(LinphoneConfig *config, const char *section, const char *key, int min_value, int max_value);
 ...
 **/
LINPHONE_PUBLIC void
linphone_config_set_bool(LinphoneConfig *config, const char *section, const char *key, bool_t value);
 ...
 **/
LINPHONE_PUBLIC void
linphone_config_set_int_hex(LinphoneConfig *config, const char *section, const char *key, int value);
 ...
 **/
LINPHONE_PUBLIC void
linphone_config_set_int64(LinphoneConfig *config, const char *section, const char *key, int64_t value);
 ...
 **/
LINPHONE_PUBLIC void
linphone_config_set_float(LinphoneConfig *config, const char *section, const char *key, float value);
 ...
 **/
LINPHONE_PUBLIC int
linphone_config_get_default_int(const LinphoneConfig *config, const char *section, const char *key, int default_value);
 ...
 * @return the found default value or default_value if not found.
 **/
LINPHONE_PUBLIC int64_t linphone_config_get_default_int64(const LinphoneConfig *config,
                                                          const char *section,
                                                          const char *key,
                                                          int64_t default_value);
 ...
 * @return the found default value or default_value if not found.
 **/
LINPHONE_PUBLIC float linphone_config_get_default_float(const LinphoneConfig *config,
                                                        const char *section,
                                                        const char *key,
                                                        float default_value);
 ...
 * @return the found default value or default_value if not found.
 **/
LINPHONE_PUBLIC const char *linphone_config_get_default_string(const LinphoneConfig *config,
                                                               const char *section,
                                                               const char *key,
 ...
 **/
LINPHONE_PUBLIC const char *linphone_config_get_section_param_string(const LinphoneConfig *config,
                                                                     const char *section,
                                                                     const char *key,
                                                                     const char *default_value);
 ...
 */
LINPHONE_PUBLIC void
linphone_config_write_relative_file(const LinphoneConfig *config, const char *filename, const char *data);
 ...
 * @donotwrap
 */
LINPHONE_PUBLIC LinphoneStatus linphone_config_read_relative_file(const LinphoneConfig *config,
                                                                  const char *filename,
                                                                  char *data,
                                                                  size_t max_length);
 ...
 **/
LINPHONE_PUBLIC bool_t linphone_config_get_overwrite_flag_for_entry(const LinphoneConfig *config,
                                                                    const char *section,
                                                                    const char *key);
 ...
 **/
LINPHONE_PUBLIC void linphone_config_set_overwrite_flag_for_entry(LinphoneConfig *config,
                                                                  const char *section,
                                                                  const char *key,
                                                                  bool_t value);
 ...
 * @return TRUE if overwrite flag is set, FALSE otherwise.
 **/
LINPHONE_PUBLIC bool_t linphone_config_get_overwrite_flag_for_section(const LinphoneConfig *config,
                                                                      const char *section);
 ...
 **/
LINPHONE_PUBLIC void
linphone_config_set_overwrite_flag_for_section(LinphoneConfig *config, const char *section, bool_t value);
 ...
 **/
LINPHONE_PUBLIC bool_t linphone_config_get_skip_flag_for_entry(const LinphoneConfig *config,
                                                               const char *section,
                                                               const char *key);
 ...
 **/
LINPHONE_PUBLIC void
linphone_config_set_skip_flag_for_entry(LinphoneConfig *config, const char *section, const char *key, bool_t value);
 ...
 **/
LINPHONE_PUBLIC void
linphone_config_set_skip_flag_for_section(LinphoneConfig *config, const char *section, bool_t value);
