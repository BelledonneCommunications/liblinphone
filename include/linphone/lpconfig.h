 ...
 */
LINPHONE_PUBLIC LinphoneDictionary * lp_config_section_to_dict(const LinphoneConfig* config, const char* section);
 ...
 */
LINPHONE_PUBLIC void lp_config_load_dict_to_section(LinphoneConfig* config, const char* section, const LinphoneDictionary* dict);

#ifdef __cplusplus
}
#endif

// 12/01/2017 Define old function names for backward compatibility
