...
void linphone_core_add_auth_info(LinphoneCore *lc, const LinphoneAuthInfo *info){
	...
	if (linphone_auth_info_get_tls_key(info) == NULL && linphone_auth_info_get_tls_key_path(info) == NULL
		&& linphone_auth_info_get_ha1(info)==NULL && linphone_auth_info_get_password(info)==NULL){
