...
void linphone_core_notify_conference_info_on_participant_error(LinphoneCore *lc, LinphoneAddress *address) {
	NOTIFY_IF_EXIST(conference_info_on_participant_error, lc, address);
	cleanup_dead_vtable_refs(lc);
}
