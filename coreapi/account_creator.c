...
void linphone_account_creator_set_pn_provider(LinphoneAccountCreator *creator, const char *pnProvider) {
	set_string(&creator->pnProvider, pnProvider, FALSE);
}

const char * linphone_account_creator_get_pn_provider(const LinphoneAccountCreator *creator) {
	return creator->pnProvider;
}

void linphone_account_creator_set_pn_param(LinphoneAccountCreator *creator, const char *pnParam) {
	set_string(&creator->pnParam, pnParam, FALSE);
}

const char * linphone_account_creator_get_pn_param(const LinphoneAccountCreator *creator) {
	return creator->pnParam;
}

void linphone_account_creator_set_pn_prid(LinphoneAccountCreator *creator, const char *pnPrid) {
	set_string(&creator->pnPrid, pnPrid, FALSE);
}

const char * linphone_account_creator_get_pn_prid(const LinphoneAccountCreator *creator) {
	return creator->pnPrid;
}
