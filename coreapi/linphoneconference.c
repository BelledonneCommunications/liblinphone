...
LinphoneStatus linphone_conference_remove_participant (LinphoneConference *obj, const LinphoneAddress * uri) {
	...
	return linphone_conference_remove_participant_with_participant (obj, participant);
}

LinphoneStatus linphone_conference_remove_participant_with_participant (LinphoneConference *obj, LinphoneParticipant *participant) {
