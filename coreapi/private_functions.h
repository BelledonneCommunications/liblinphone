...
LinphoneAccount * linphone_core_find_account_by_identity_address(const LinphoneCore *core, const LinphoneAddress *identity_address);
...
bool_t _linphone_friend_has_phone_number(const LinphoneFriend *lf, const LinphoneAccount *account, const char *normalized_phone_number);
...
LINPHONE_PUBLIC void linphone_core_set_push_notification_config(LinphoneCore *core, LinphonePushNotificationConfig* config);
