...
static void misc_config_read (LinphoneCore *lc) {
	...
	if (lc->user_certificates_path) bctbx_free(lc->user_certificates_path);
		lc->user_certificates_path = bctbx_strdup(linphone_config_get_string(config, "misc", "user_certificates_path", linphone_factory_get_data_dir(linphone_factory_get(), nullptr)));
