...
static void _linphone_core_init_account_creator_service(LinphoneCore *lc) {
	...
	service->account_creator_service_constructor_cb = linphone_account_creator_constructor_linphone_xmlrpc;
	service->account_creator_service_destructor_cb = NULL;
	service->create_account_request_cb = linphone_account_creator_create_account_linphone_xmlrpc;
	service->delete_account_request_cb = linphone_account_creator_delete_account_linphone_xmlrpc;
	service->is_account_exist_request_cb = linphone_account_creator_is_account_exist_linphone_xmlrpc;
	service->confirmation_key_request_cb = linphone_account_creator_get_confirmation_key_linphone_xmlrpc;
	service->activate_account_request_cb = linphone_account_creator_activate_phone_account_linphone_xmlrpc;
	service->is_account_activated_request_cb = linphone_account_creator_is_account_activated_linphone_xmlrpc;
	service->link_account_request_cb = linphone_account_creator_link_phone_number_with_account_linphone_xmlrpc;
	service->activate_alias_request_cb = linphone_account_creator_activate_phone_number_link_linphone_xmlrpc;
	service->is_alias_used_request_cb = linphone_account_creator_is_phone_number_used_linphone_xmlrpc;
	service->is_account_linked_request_cb = linphone_account_creator_is_account_linked_linphone_xmlrpc;
	service->recover_account_request_cb = linphone_account_creator_recover_phone_account_linphone_xmlrpc;
	service->update_account_request_cb = linphone_account_creator_update_password_linphone_xmlrpc;
	service->login_linphone_account_request_cb = linphone_account_creator_login_linphone_account_linphone_xmlrpc;
