...
static void sip_config_read(LinphoneCore *lc) {
	...
	bool_t auto_download_voice_recordings = linphone_config_get_bool(lc->config, "app", "auto_download_incoming_voice_recordings", FALSE);
...
bool_t linphone_core_auto_download_voice_recordings_enabled(LinphoneCore *lc) {
	return lc->auto_download_incoming_voice_recordings;
}

void linphone_core_enable_auto_download_voice_recordings(LinphoneCore *lc, bool_t auto_download_voice_recordings) {
