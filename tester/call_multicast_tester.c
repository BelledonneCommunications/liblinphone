...
static test_t multicast_call_tests[] = {
...
#ifdef VIDEO_ENABLED
    TEST_ONE_TAG("Multicast video call", call_multicast_video, "shaky"),
    TEST_ONE_TAG("Early media multicast video call", early_media_with_multicast_video, "shaky"),
#endif
};
