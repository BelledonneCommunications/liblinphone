...
static void liblinphone_android_ortp_log_handler(BCTBX_UNUSED(const char *domain), OrtpLogLevel lev, const char *fmt, va_list args) {
	int prio;
	switch(lev){
...
static void liblinphone_android_bctbx_log_handler(BCTBX_UNUSED(const char *domain), BctbxLogLevel lev, const char *fmt, va_list args) {
	int prio;
	switch(lev){
...
JNIEXPORT void JNICALL Java_org_linphone_tester_Tester_setApplicationContext(JNIEnv *env, BCTBX_UNUSED(jclass obj), jobject context) {
...
JNIEXPORT void JNICALL Java_org_linphone_tester_Tester_keepAccounts(BCTBX_UNUSED(JNIEnv *env), BCTBX_UNUSED(jclass c), jboolean keep) {
	liblinphone_tester_keep_accounts((int)keep);
}

JNIEXPORT void JNICALL Java_org_linphone_tester_Tester_clearAccounts(BCTBX_UNUSED(JNIEnv *env), BCTBX_UNUSED(jclass c)) {
...
void liblinphone_tester_add_suites(void) {
	liblinphone_tester_add_suite_with_default_time(&setup_test_suite, 83);
	liblinphone_tester_add_suite_with_default_time(&register_test_suite, 267);
#ifdef HAVE_ADVANCED_IM
	liblinphone_tester_add_suite_with_default_time(&group_chat_test_suite, 500);
	liblinphone_tester_add_suite_with_default_time(&group_chat2_test_suite, 583);
#ifdef HAVE_LIME_X3DH
	liblinphone_tester_add_suite_with_default_time(&secure_group_chat_test_suite, 616);
	liblinphone_tester_add_suite_with_default_time(&secure_message_test_suite, 503);
	...
	liblinphone_tester_add_suite_with_default_time(&local_conference_test_suite_scheduled_conference_basic, 280);
	liblinphone_tester_add_suite_with_default_time(&local_conference_test_suite_scheduled_conference_advanced, 459);
	liblinphone_tester_add_suite_with_default_time(&local_conference_test_suite_scheduled_ice_conference, 271);
	liblinphone_tester_add_suite_with_default_time(&local_conference_test_suite_inpromptu_conference, 529);
	liblinphone_tester_add_suite_with_default_time(&local_conference_test_suite_chat, 730);
	...
	liblinphone_tester_add_suite_with_default_time(&call_test_suite, 649);
	...
	liblinphone_tester_add_suite_with_default_time(&call_secure_test_suite, 324);
	liblinphone_tester_add_suite_with_default_time(&capability_negotiation_test_suite, 494);
	liblinphone_tester_add_suite_with_default_time(&capability_negotiation_no_sdp_test_suite, 266);
	liblinphone_tester_add_suite_with_default_time(&srtp_capability_negotiation_basic_test_suite, 363);
	...
	liblinphone_tester_add_suite_with_default_time(&zrtp_capability_negotiation_test_suite, 286);
	liblinphone_tester_add_suite_with_default_time(&dtls_srtp_capability_negotiation_basic_test_suite, 271);
	liblinphone_tester_add_suite_with_default_time(&dtls_srtp_capability_negotiation_test_suite, 144);
	liblinphone_tester_add_suite_with_default_time(&ice_capability_negotiation_test_suite, 10);
	liblinphone_tester_add_suite_with_default_time(&srtp_ice_capability_negotiation_test_suite, 98);
	liblinphone_tester_add_suite_with_default_time(&zrtp_ice_capability_negotiation_test_suite, 79);
	...
	liblinphone_tester_add_suite_with_default_time(&call_video_test_suite, 644);
	liblinphone_tester_add_suite_with_default_time(&call_video_msogl_test_suite, 643);// Conditionals are defined in suite
	...
	liblinphone_tester_add_suite_with_default_time(&audio_quality_test_suite, 119);
	liblinphone_tester_add_suite_with_default_time(&audio_video_conference_basic_test_suite, 530);
	liblinphone_tester_add_suite_with_default_time(&audio_conference_test_suite, 504);
	liblinphone_tester_add_suite_with_default_time(&video_conference_test_suite, 555);
...
#endif
	liblinphone_tester_add_suite_with_default_time(&stun_test_suite, 248);
	...
	liblinphone_tester_add_suite_with_default_time(&quality_reporting_test_suite, 47);
	...
	liblinphone_tester_add_suite_with_default_time(&recorder_test_suite, 15);
	...
	liblinphone_tester_add_suite_with_default_time(&main_db_test_suite, 6);
...
#endif
#ifdef VCARD_ENABLED
//	liblinphone_tester_add_suite_with_default_time(&vcard_test_suite, 0);
#endif
	liblinphone_tester_add_suite_with_default_time(&utils_test_suite, 0);
	liblinphone_tester_add_suite_with_default_time(&call_with_rtp_bundle_test_suite, 96);
	...
	liblinphone_tester_add_suite_with_default_time(&external_domain_test_suite, 143);
