...
static LinphoneAccountCreator* init_linphone_account_creator_service(LinphoneCore *lc) {
...
static void server_account_exist(void) {
	...
	LinphoneAccountCreator *creator = init_linphone_account_creator_service(marie->lc);
