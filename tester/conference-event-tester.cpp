...
"     ENDPOINTS"\
"   -->"\
"      <endpoint entity=\"sip:4kfk4j392jsu@example.com;grid=433kj4j3u\" xmlns:p1=\"urn:oma:xml:prs:pidf:oma-pres\">"\
"       <status>connected</status>"\
"       <joining-method>dialed-out</joining-method>"\
"       <joining-info>"\
"        <when>2005-03-04T20:00:00Z</when>"\
...
"			<p1:service-id>ephemeral</p1:service-id>"\
"			<p1:version>1.0</p1:version>"\
"  		</p1:service-description>"\
"  		<p1:service-description>"\
"			<p1:service-id>groupchat</p1:service-id>"\
"			<p1:version>1.1</p1:version>"\
"  		</p1:service-description>"\
"  		<p1:service-description>"\
"			<p1:service-id>lime</p1:service-id>"\
"			<p1:version>1.0</p1:version>"\
"  		</p1:service-description>"\
"   <!--"\
"     MEDIA"\
