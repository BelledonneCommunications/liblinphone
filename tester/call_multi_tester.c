...
// Pauline accept Marie
	...
	BC_ASSERT_TRUE(wait_for_list(core_list,&marieToneStats->number_of_startNamedTone,1, 5000));	// Ringing while incall
...
// Marie accept Laure	
	...
	BC_ASSERT_TRUE(wait_for_list(core_list,&marieToneStats->number_of_stopTone,1, 5000));	// End of named tone
