...
static void multidomain_group_chat_room (void) {
	...
	BC_ASSERT_TRUE(wait_for_list(coresList, &laure.getCMgr()->stat.number_of_ChatRoomConferenceDetailsReceived, initialLaureStats.number_of_ChatRoomConferenceDetailsReceived + 1, 5000));
	...
	BC_ASSERT_TRUE(wait_for_list(coresList, &laure.getCMgr()->stat.number_of_ChatRoomConferenceDetailsReceived, initialLaureStats.number_of_ChatRoomConferenceDetailsReceived + 2, 5000));
