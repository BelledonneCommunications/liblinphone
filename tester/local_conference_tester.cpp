...
static void group_chat_room_with_client_restart_base(bool encrypted) {
	...
	{ // to make sure focus is destroyed after clients.
		...
		ms_message("%s is adding device %s", linphone_core_get_identity(focus.getLc()), linphone_address_as_string(michelle2Contact));
...
static void group_chat_room_with_client_registering_with_short_register_expires(void) {
	...
	{ // to make sure focus is destroyed after clients.
		...
		ms_message("%s is registering again with expires set to %0d seconds", linphone_address_as_string(michelleContact), expires);
...
static void group_chat_room_with_client_restart_removed_from_server(void) {
	...
	{ // to make sure focus is destroyed after clients.
		...
		linphone_participant_device_identity_set_capability_descriptor_2(identity, linphone_core_get_linphone_specs_list(michelle.getLc()));
		devices = bctbx_list_append(devices, identity);
