...
void liblinphone_tester_chat_message_state_change(LinphoneChatMessage* msg,LinphoneChatMessageState state,BCTBX_UNUSED(void* ud)) {
...
static void text_message_with_credential_from_auth_cb_auth_info_requested(LinphoneCore *lc, const char *realm, const char *username, BCTBX_UNUSED(const char *domain)) {
...
static int enable_lime_for_message_test(BCTBX_UNUSED(LinphoneCoreManager *marie), BCTBX_UNUSED(LinphoneCoreManager *pauline)) {
#ifdef HAVE_SQLITE
	char* stmt = NULL;
	char* errmsg=NULL;
	int ret = 0;
...
static int im_encryption_engine_process_outgoing_message_async(BCTBX_UNUSED(LinphoneImEncryptionEngine *engine), BCTBX_UNUSED(LinphoneChatRoom *room), LinphoneChatMessage *msg) {
	if (strcmp(linphone_chat_message_get_content_type(msg),"cipher/b64") == 0)
...
static int im_encryption_engine_process_incoming_message_async(BCTBX_UNUSED(LinphoneImEncryptionEngine *engine), LinphoneChatRoom *room, LinphoneChatMessage *msg) {
