...
static void transfer_message_tls_client_auth(void) {
	if (transport_supported(LinphoneTransportTls)) {
		...
		// This is not a problem as the file transfer server won't check the individual access.
		add_tls_client_certificate(marie->lc, "user_1", "sip.example.org", "certificates/client/user1_cert.pem", "certificates/client/user1_key.pem");
		add_tls_client_certificate(pauline->lc, "user_2", "sip.example.org", "certificates/client/user2_cert.pem", "certificates/client/user2_key.pem");
