...
test_t dtls_srtp_capability_negotiation_general_tests[] = {
...
test_suite_t dtls_srtp_capability_negotiation_general_test_suite = {"DTLS SRTP Capability Negotiation (General)", NULL, NULL, liblinphone_tester_before_each, liblinphone_tester_after_each,
								sizeof(dtls_srtp_capability_negotiation_general_tests) / sizeof(dtls_srtp_capability_negotiation_general_tests[0]), dtls_srtp_capability_negotiation_general_tests};
