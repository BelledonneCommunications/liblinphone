...
extern "C" LinphonePushNotificationConfig* linphone_core_get_push_notification_config(LinphoneCore *core);
...
static void remote_provisioning_file(void) {
	...
	BC_ASSERT_STRING_EQUAL(linphone_push_notification_config_get_voip_token(linphone_core_get_push_notification_config(marie->lc)), "token:voip");
