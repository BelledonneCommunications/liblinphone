...
static void simple_call_with_audio_devices_reload(void) {
	...
	BC_ASSERT_EQUAL(marie->stat.number_of_LinphoneCoreAudioDeviceChanged, 5, int, "%d");
	...
	BC_ASSERT_EQUAL(marie->stat.number_of_LinphoneCoreAudioDeviceChanged, 7, int, "%d");
