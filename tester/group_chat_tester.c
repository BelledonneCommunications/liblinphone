...
static void exhume_one_to_one_chat_room_3_base(bool_t core_restart) {
	...
	if (marieOneToOneCr) {
		...
		LinphoneAddress *pauline_addr_before_exhume = linphone_address_new(linphone_core_get_identity(pauline->lc));
		LinphoneParticipant *pauline_participant_before_exhume = linphone_chat_room_find_participant(marieOneToOneCr, pauline_addr_before_exhume);
		BC_ASSERT_PTR_NOT_NULL(pauline_participant_before_exhume);
		BC_ASSERT_EQUAL(bctbx_list_size(linphone_participant_get_devices (pauline_participant_before_exhume)), 1, int, "%i");
		...
		BC_ASSERT_EQUAL(bctbx_list_size(linphone_participant_get_devices (pauline_participant_before_exhume)), 2, int, "%i");
		...
		if (exhumedConfAddr) {
			...
			LinphoneAddress *pauline_addr_after_exhume = linphone_address_new(linphone_core_get_identity(pauline->lc));
			LinphoneParticipant *pauline_participant_after_exhume = linphone_chat_room_find_participant(marieOneToOneCr, pauline_addr_after_exhume);
			linphone_address_unref(pauline_addr_after_exhume);
			BC_ASSERT_PTR_NOT_NULL(pauline_participant_after_exhume);
			BC_ASSERT_EQUAL(bctbx_list_size(linphone_participant_get_devices (pauline_participant_after_exhume)), 2, int, "%i");
		...
		BC_ASSERT_EQUAL(bctbx_list_size(pauline2_chat_rooms), 1, int , "%d");
