...
static void group_chat_room_add_admin_lately_notified (void) {
	...
	// We have to wait for the NOTIFY to arrive before shutting down the network
	// Otherwise pauline admin status will be taken into account but won't be considered as a "change"
	// And below assertion number_of_participant_admin_statuses_changed will be false
	wait_for_list(coresList, &pauline->stat.number_of_ChatRoomConferenceDetailsReceived, pauline->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
...
static void group_chat_room_leave (void) {
	...
	// Wait for pauline to receive the NOTIFY or she won't be able to leave the chat room
	wait_for_list(coresList, &pauline->stat.number_of_ChatRoomConferenceDetailsReceived, pauline->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
...
static void group_chat_room_reinvited_after_removed_base (bool_t offline_when_removed, bool_t offline_when_reinvited, bool_t restart_after_reinvited) {
	...
	wait_for_list(coresList, &laure->stat.number_of_ChatRoomConferenceDetailsReceived, laure->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
	...
	BC_ASSERT_TRUE(wait_for_list(coresList, &laure->stat.number_of_ChatRoomConferenceDetailsReceived, initialLaureStats.number_of_ChatRoomConferenceDetailsReceived + 1, 10000));
...
static void group_chat_room_send_refer_to_all_devices (void) {
	...
	// Wait for NOTIFY to be received otherwise admin information will be wrong
	wait_for_list(coresList, &pauline1->stat.number_of_ChatRoomConferenceDetailsReceived, pauline1->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
	wait_for_list(coresList, &pauline2->stat.number_of_ChatRoomConferenceDetailsReceived, pauline2->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
	wait_for_list(coresList, &laure->stat.number_of_ChatRoomConferenceDetailsReceived, laure->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
...
static void group_chat_room_new_unique_one_to_one_chat_room_after_both_participants_left (void) {
	...
	// Wait for notify
	wait_for_list(coresList, &marie->stat.number_of_ChatRoomConferenceDetailsReceived, marie->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
	wait_for_list(coresList, &pauline->stat.number_of_ChatRoomConferenceDetailsReceived, pauline->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
...
static void find_one_to_one_chat_room (void) {
	...
	// Wait for notify
	wait_for_list(coresList, &chloe->stat.number_of_ChatRoomConferenceDetailsReceived, chloe->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
...
static void group_chat_room_participant_devices_name (void) {
	...
	// Wait for notify
	wait_for_list(coresList, &chloe->stat.number_of_ChatRoomConferenceDetailsReceived, chloe->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
	wait_for_list(coresList, &chloe2->stat.number_of_ChatRoomConferenceDetailsReceived, chloe2->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
	...
	// Wait for notify
	wait_for_list(coresList, &chloe3->stat.number_of_ChatRoomConferenceDetailsReceived, chloe3->stat.number_of_ChatRoomConferenceDetailsReceived + 1, 5000);
