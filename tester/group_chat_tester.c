...
static void group_chat_lime_v2_with_zrtp_verification (void) {
	...
	// Check chat room security level is Safe
...
static void group_chat_lime_v2_chatroom_security_alert (void) {
	...
	participantsAddresses = NULL;
	participantsAddresses = bctbx_list_append(participantsAddresses, linphone_address_new(linphone_core_get_identity(pauline2->lc)));
	linphone_chat_room_add_participants(marieCr, participantsAddresses);
	bctbx_list_free_with_data(participantsAddresses, (bctbx_list_free_func)linphone_address_unref);
	participantsAddresses = NULL;
...
static void group_chat_lime_v2_encrypted_message_not_decrypted (void) {
	...
	// TODO Simulate incorrect decryption
...
test_t group_chat_tests[] = {
	...
	TEST_ONE_TAG("LIMEv2 message to disabled LIMEv2", group_chat_lime_v2_send_encrypted_message_to_disabled_lime_v2, "CreateUserInDb"),
