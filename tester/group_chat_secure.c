...
static void mixed_ephemeral_message_test (void) {
	...
	BC_ASSERT_TRUE(wait_for_list(coresList, &marie->stat.number_of_LinphoneChatRoomEphemeralRead, initialMarieStats.number_of_LinphoneChatRoomEphemeralRead + 1, 3000));
	BC_ASSERT_TRUE(wait_for_list(coresList, &pauline->stat.number_of_LinphoneChatRoomEphemeralRead, initialPaulineStats.number_of_LinphoneChatRoomEphemeralRead + 1, 3000));
