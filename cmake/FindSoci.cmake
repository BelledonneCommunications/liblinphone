...
if(TARGET soci_core OR TARGET soci_core_static)
    ...
    foreach(_Soci_PLUGIN IN LISTS _Soci_ALL_PLUGINS)
       if(TARGET soci_${_Soci_PLUGIN} OR TARGET soci_${_Soci_PLUGIN}_static)
          list(APPEND _Soci_REQUIRED_VARS Soci_${_Soci_PLUGIN}_TARGET)
          if(TARGET soci_${_Soci_PLUGIN})
             set(Soci_${_Soci_PLUGIN}_TARGET soci_${_Soci_PLUGIN})
          else()
             set(Soci_${_Soci_PLUGIN}_TARGET soci_${_Soci_PLUGIN}_static)
          endif()
