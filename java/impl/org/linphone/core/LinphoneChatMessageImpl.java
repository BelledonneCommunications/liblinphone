...
public class LinphoneChatMessageImpl implements LinphoneChatMessage {
  ...
  private native void setListener(long ptr,
                                  LinphoneChatMessageListener listener);
  private native void unref(long ptr);

  protected LinphoneChatMessageImpl(long aNativePtr) { nativePtr = aNativePtr; }
  ...
  private native void addCustomHeader(long nativePtr, String name,
                                      String value);
  @Override
  ...
  public boolean isRead() { return isRead(nativePtr); }

  public boolean isOutgoing() { return isOutgoing(nativePtr); }

  public void store() { store(nativePtr); }

  public int getStorageId() { return getStorageId(nativePtr); }

  private native int getReason(long ptr);

  public Reason getReason() { return Reason.fromInt(getReason(nativePtr)); }
