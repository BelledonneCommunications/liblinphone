...
class LpConfigImpl implements LpConfig {
  ...
  public LpConfigImpl(long ptr) { nativePtr = ptr; }
  ...
  private native void setFloat(long ptr, String section, String key,
                               float value);
  @Override
  ...
  private native void setBool(long ptr, String section, String key,
                              boolean value);
  @Override
  ...
  private native void setString(long ptr, String section, String key,
                                String value);
  @Override
  ...
  private native void setIntRange(long ptr, String section, String key, int min,
                                  int max);
  @Override
  ...
  private native int getInt(long ptr, String section, String key,
                            int defaultValue);
  @Override
  ...
  private native float getFloat(long ptr, String section, String key,
                                float defaultValue);
  @Override
  ...
  getBool(long ptr, String section, String key, boolean defaultValue);
  @Override
  ...
  getString(long ptr, String section, String key, String defaultValue);
  @Override
  public String getString(String section, String key, String defaultValue) {
    return getString(nativePtr, section, key, defaultValue);
  }

  private native int[] getIntRange(long ptr, String section, String key,
                                   int defaultMin, int defaultMax);
  @Override
  public int[] getIntRange(String section, String key, int defaultMin,
                           int defaultMax) {
