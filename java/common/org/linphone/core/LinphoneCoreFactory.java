...
abstract public class LinphoneCoreFactory {
    ...
    try {
      if (theLinphoneCoreFactory == null) {
        ...
        theLinphoneCoreFactory =
            (LinphoneCoreFactory)lFactoryClass.newInstance();
      }
    } catch (Exception e) {
   ...
   * @param passwd
   * */
  abstract public LinphoneAuthInfo
  createAuthInfo(String username, String password, String realm, String domain);
  /**
   * create  {@link LinphoneAuthInfo}
   * @param username
   * @param userid user id as set in auth header
  ...
  abstract public LinphoneAuthInfo createAuthInfo(String username,
                                                  ...
                                                  String ha1, String realm,
                                                  String domain);

  /**
   * Create a LinphoneCore object. The LinphoneCore is the root for all
   * liblinphone operations. You need only one per application.
   ...
   * @param factoryConfig path where to read factory configuration
   * (optional)
   * @param userdata any kind of application specific data
   * @param context an application context, on android this MUST be the
   * android.content.Context object used by the application.
   * @return a LinphoneCore object.
   * @throws LinphoneCoreException
   */
  abstract public LinphoneCore
   ...
   * @throws LinphoneCoreException
   */
  abstract public LinphoneCore createLinphoneCore(LinphoneCoreListener listener,
                                                  Object context)
      throws LinphoneCoreException;
   ...
   * @return
   */
  abstract public LinphoneAddress
  createLinphoneAddress(String username, String domain, String displayName);
  /**
   * Constructs a LinphoneAddress object by parsing the user supplied
   ...
   * @param friendUri a buddy address, must be a sip uri like
   ...
   */
  abstract public LinphoneContent
  createLinphoneContent(String type, String subType, String data);

  /**
   * Create a LinphoneContent object from byte array.
   */
  abstract public LinphoneContent createLinphoneContent(String type,
                                                        String subType,
                                                        byte[] data,
                                                        String encoding);
   ...
   */
  abstract public PresenceActivity
  createPresenceActivity(PresenceActivityType type, String description);

  /**
   * Create a PresenceService object.
   * @param id The id of the presence service. Can be null to generate it
   * automatically.
   * @param status The PresenceBasicStatus to set for the PresenceService
   * object.
   * @param contact The contact to set for the PresenceService object. Can
   * be null.
   * @return A new PresenceService object.
   */
  abstract public PresenceService
  ...
  abstract public PresenceModel createPresenceModel(PresenceActivityType type,
                                                    String description);
  abstract public PresenceModel createPresenceModel(PresenceActivityType type,
                                                    String description,
